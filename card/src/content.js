...
export const CONTENT = {
  de: {
    ...
    exchange: {
      ...
      intro: "Kurz anmelden, dann schreiben. Was Sie schreiben, sehen nur Sie und ich — niemand sonst.",
      emailLabel: "Ihre E-Mail-Adresse",
      emailPlaceholder: "name@firma.de",
      sendLink: "Anmeldelink schicken",
      sendingLink: "Wird geschickt …",
      linkSent: "Link ist unterwegs.",
      linkSentBody: "Öffnen Sie die E-Mail an {email} und klicken Sie auf den Link — am besten auf diesem Gerät. Falls nichts ankommt, schauen Sie kurz im Spam-Ordner.",
      linkAgain: "Andere Adresse verwenden",
      errorEmail: "Bitte eine gültige E-Mail-Adresse eingeben.",
      errorLink: "Der Link konnte nicht verschickt werden. Bitte in einer Minute noch einmal versuchen.",
      or: "oder",
  ...
  en: {
    ...
    exchange: {
      ...
      intro: "Sign in briefly, then write. What you write is visible to you and me only — nobody else.",
      emailLabel: "Your email address",
      emailPlaceholder: "name@company.com",
      sendLink: "Send me a sign-in link",
      sendingLink: "Sending …",
      linkSent: "The link is on its way.",
      linkSentBody: "Open the email sent to {email} and click the link — ideally on this device. If nothing arrives, check your spam folder.",
      linkAgain: "Use a different address",
      errorEmail: "Please enter a valid email address.",
      errorLink: "The link could not be sent. Please try again in a minute.",
      or: "or",
